...
_G.packer_plugins = {
  ...
  ["gruvbox-material"] = {
    loaded = true,
    path = "/Users/imac/.local/share/nvim/site/pack/packer/start/gruvbox-material",
  ...
  phpactor = {
    config = { "\27LJ\2\n?\0\0\2\0\4\0\0056\0\0\0009\0\1\0'\1\3\0=\1\2\0K\0\1\0\17/usr/bin/php\21phpactor_php_bin\6g\bvim\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "/Users/imac/.local/share/nvim/site/pack/packer/opt/phpactor",
  ...
  ["vim-gruvbox8"] = {
    loaded = true,
    path = "/Users/imac/.local/share/nvim/site/pack/packer/start/vim-gruvbox8",
    url = "https://github.com/lifepillar/vim-gruvbox8"
  },
  ["vim-matchup"] = {
    loaded = true,
    path = "/Users/imac/.local/share/nvim/site/pack/packer/start/vim-matchup",
